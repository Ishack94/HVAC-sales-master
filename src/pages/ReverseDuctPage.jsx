    ...
    <>
      ...
      <div className={styles.layout}>
        <main className={styles.main}>
          ...
          <Link to="/resources/hvac-load-calculator" style={{ fontFamily: "'Figtree', sans-serif", fontSize: '15px', fontWeight: 600, color: '#1f6cb8', textDecoration: 'none', marginTop: '12px', display: 'inline-block' }}>Next: Run a load calculation →</Link>
        </main>
        <Sidebar />
      </div>
    </>
