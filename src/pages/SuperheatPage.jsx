    ...
    <>
      ...
      <div className={styles.layout}>
        <main className={styles.main}>
          ...
          <Link to="/troubleshoot" style={{ fontFamily: "'Figtree', sans-serif", fontSize: '15px', fontWeight: 600, color: '#1f6cb8', textDecoration: 'none', marginTop: '12px', display: 'inline-block' }}>Next: Troubleshoot a furnace →</Link>
        </main>
        <Sidebar />
      </div>
    </>
